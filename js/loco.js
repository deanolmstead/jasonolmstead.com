! function() {
    ...
    function V(t) {
        ! function(t) {
            ...
            if (0 === e.length)
                for (var i in t) B.call(t, i) && "function" == typeof t[i] && "[object Function]" == j.call(t[i]) && e.push(i);
                ...
                value: function() {
                    ...
                    this.els = {}, this.parallaxElements = {}, this.el.querySelectorAll("[data-".concat(this.name, "]")).forEach((function(e, i) {
                        ...
                        if (v) {
                            ...
                            s += window.innerHeight, n += window.innerWidth, S = T + o.offsetHeight - e.offsetHeight - O[t.directionAxis], k = {
